...
describe('Auth Store', () => {
  ...
  it('logs in user', async () => {
    const mockUser = { id: 1, name: 'John', email: 'john@example.com', username: 'john', phone: '0912345678', email_verified_at: null, created_at: '2026-01-01', updated_at: '2026-01-01' }
  ...
  it('logs out user', async () => {
    ...
    act(() => {
      useAuthStore.setState({
        user: { id: 1, name: 'John', email: 'john@example.com', username: 'john', phone: '0912345678', email_verified_at: null, created_at: '2026-01-01', updated_at: '2026-01-01' },
        token: 'token-123',
