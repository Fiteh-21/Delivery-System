# Delivery System - Tool Documentation

This folder contains documentation for all tools, packages, and configurations used in this Laravel Delivery System project.
...
|---|---|---|
| `APP_NAME` | Application name | `Delivery System` |
